            ...
            <div className="p-4 sm:p-6 rounded-lg border border-gray-200">
                ...
                <div className="flex flex-col sm:flex-row justify-between mb-8">
                    ...
                    <div className="flex flex-col items-start sm:items-end mt-4 sm:mt-0">
                        <span 
                        className={`${orderDetails.isPaid ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"} px-3 py-1 round-full text-sm font-medium mb-2`}>
                            {orderDetails.isPaid ? "Approved" : "Pending"}
                        </span>
                          <span 
                        className={`${orderDetails.isDelivered ? "bg-green-100 text-green-700" : "bg-yellow-100 text-yellow-700"} px-3 py-1 round-full text-sm font-medium mb-2`}>
                    ...
                    <table className="min-w-full text-gray-600 mb-4">
                        ...
                        <tbody>
                            {orderDetails.orderItems.map((item) => (
                                <tr key={items.productID} className="border-b border-gray-200">
