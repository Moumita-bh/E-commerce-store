    ...
    <section className="py-16 px-4 lg:px-0">
      <div className="container mx-auto text-center mb-10 relative">
        ...
        <p className="text-lg text-gray-600 mb-8">
          ...
          freshly added to keep pur wardrobe on the cutting edge of fashion.
        </p>
...
>
          ...
          <button onClick={() => scroll("right")}  className={`p-2 rounded border border-gray-200 ${
      ...
      {/* Scrollable Content */}
      <div ref={scrollRef} className={`container mx-auto overflow-x-scroll scrollbar-hide flex space-x-6 relative
      ${isDragging ? "cursor-grabbing" : "cursor-grab"} hide-scrollbar`} 
